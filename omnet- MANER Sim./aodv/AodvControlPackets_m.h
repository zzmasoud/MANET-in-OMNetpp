...
class INET_API Rreq : public ::inet::aodv::AodvControlPacket
{
  protected:
    ...
    std::string zzRequestedServices_req = "0";
  ...
  public:
    ...
    virtual std::string getZZRequestedServices_req() const;
    virtual void setZZRequestedServices_req(std::string requestedServices);
};
...
class INET_API Rrep : public ::inet::aodv::AodvControlPacket
{
  protected:
    ...
    std::string zzRequestedServices_rep = 0;
  ...
  public:
    ...
    virtual std::string getZZRequestedServices_rep() const;
    virtual void setZZRequestedServices_rep(std::string requestedServices);
};
...
class INET_API Rerr : public ::inet::aodv::AodvControlPacket
{
  protected:
    ...
    std::string zzRequestedServices_rer = "0";
  ...
  public:
    ...
    virtual std::string getZZRequestedServices_rer() const;
    virtual void setZZRequestedServices_rer(std::string requestedServices);
};
