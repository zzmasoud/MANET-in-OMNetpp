...
void Rrep::copy(const Rrep& other)
{
    ...
    this->zzRequestedServices_rep = other.zzRequestedServices_rep;
}
...
std::string Rrep::getZZRequestedServices_rep() const
{
    return this->zzRequestedServices_rep;
}

void Rrep::setZZRequestedServices_rep(std::string requestedServices)
{
    handleChange();
    this->zzRequestedServices_rep = requestedServices;
}
...
std::string Rerr::getZZRequestedServices_rer() const
{
    return this->zzRequestedServices_rer;
}

void Rerr::setZZRequestedServices_rer(std::string requestedServices)
{
    handleChange();
    this->zzRequestedServices_rer = requestedServices;
}
