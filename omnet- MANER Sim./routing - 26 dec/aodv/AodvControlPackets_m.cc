...
void Rreq::copy(const Rreq& other)
{
    ...
    this->zzRequestedService_req = other.zzRequestedService_req;
}
...
unsigned int Rreq::getZZRequestedService_req() const
{
    return this->zzRequestedService_req;
}

void Rreq::setZZRequestedService_req(unsigned int requestedService)
{
    handleChange();
    this->zzRequestedService_req = requestedService;
}
...
void Rrep::copy(const Rrep& other)
{
    ...
    this->zzRequestedService_rep = other.zzRequestedService_rep;
}
...
unsigned int Rrep::getZZRequestedService_rep() const
{
    return this->zzRequestedService_rep;
}

void Rrep::setZZRequestedService_rep(unsigned int requestedService)
{
    handleChange();
    this->zzRequestedService_rep = requestedService;
}
...
unsigned int Rerr::getZZRequestedService_rer() const
{
    return this->zzRequestedService_rer;
}

void Rerr::setZZRequestedService_rer(unsigned int requestedService)
{
    handleChange();
    this->zzRequestedService_rer = requestedService;
}
