...
class INET_API Rreq : public ::inet::aodv::AodvControlPacket
{
  protected:
    ...
    unsigned int zzRequestedService_req = 0;
  ...
  public:
    ...
    virtual unsigned int getZZRequestedService_req() const;
    virtual void setZZRequestedService_req(unsigned int requestedService);
};
...
class INET_API Rrep : public ::inet::aodv::AodvControlPacket
{
  protected:
    ...
    unsigned int zzRequestedService_rep = 0;
  ...
  public:
    ...
    virtual unsigned int getZZRequestedService_rep() const;
    virtual void setZZRequestedService_rep(unsigned int requestedService);
};
...
class INET_API Rerr : public ::inet::aodv::AodvControlPacket
{
  protected:
    ...
    unsigned int zzRequestedService_rer = 0;
  ...
  public:
    ...
    virtual unsigned int getZZRequestedService_rer() const;
    virtual void setZZRequestedService_rer(unsigned int requestedService);
};
